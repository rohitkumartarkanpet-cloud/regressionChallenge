...
Even with a high \(R^2\) and at least one very small p-value, this model suggests the opposite of the truth about social media time.
...
Everything in the regression table would look legitimate: high \(R^2\), at least one significant coefficient, and reasonable standard errors.
