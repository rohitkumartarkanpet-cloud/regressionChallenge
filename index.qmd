...
- Intercept \( \hat\alpha_0 \approx -1.52 \)  
- Slope on StressSurvey \( \hat\alpha_1 \approx 1.05 \)  
- \( R^2 \approx 0.90 \)
...
- Intercept \( \hat\gamma_0 \approx -3.68 \)  
- Slope on Time \( \hat\gamma_1 \approx 5.34 \)  
- \( R^2 \approx 0.56 \)
...
- StressSurvey coefficient \( \hat\delta_1 \approx 1.43 \) (positive, significant)  
- Time coefficient \( \hat\delta_2 \approx -2.78 \) (negative, significant)  
- \( R^2 \approx 0.94 \)
...
- Stress coefficient \( \hat\beta_1 = 1.0 \)  
- Time coefficient \( \hat\beta_2 = 0.1 \)  
- \( R^2 = 1.0 \)
...
- StressSurvey coefficient \( \approx 0.33 \)  
